...
-   第三次握手，客户端收到 SYN 报文之后，会发送一个 ACK 报文，值为 ISN+1，此时客
    ...
    ，此时，双方已建立起了连接
    ![http三次握手](/images/interview_http_tcp_woshou.png) 上述每一次握手的作用
    如下：
...
-   第四次挥手：客户端收到 FIN 之后，一样发送一个 ACK 报文作为应答，且把服务端的
    ...
    ![http四次挥手](/images/interview_http_tcp_huishou.png)
...
![http三次握手和四次挥手](/images/interview_http_tcp_wohui.png)
